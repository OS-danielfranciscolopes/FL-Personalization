...
We provide an [example](/fedpfl/federated_learning/example) which was adapted from ["Flower Example using PyTorch"](https://github.com/adap/flower/tree/2728140a28514b3174fafee0c64d368e8b568645/examples/quickstart_pytorch).
...
```bash
git clone https://github.com/OS-danielfranciscolopes/FL-Personalization.git fl_personalization
```
...
This work was done in the scope of a curricular
internship at [OutSystems](https://www.outsystems.com/). This work was done in collaboration with:
- João Nadkarni (joao.nadkarni@outsystems.com)
- Filipe Assunção (filipe.assuncao@outsystems.com)
- Miguel Lopes (miguel.gomes.lopes@outsystems.com)
- Professor Luís Rodrigues (ler@tecnico.ulisboa.pt) INESC-ID, Instituto Superior Técnico, Universidade de Lisboa
